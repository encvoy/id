---
title: "Benutzerverwaltung in {{projectName}} — Administrator-Handbuch"
description: "Erfahren Sie, wie Sie Benutzer in {{projectName}} verwalten: Erstellung und Bearbeitung, Sperrung und Löschung, Zugriffskontrolle und Datenschutzverwaltung."
keywords: 
  - Benutzerverwaltung {{projectName}}
  - Benutzer erstellen {{projectName}}
  - Benutzerprofil bearbeiten
  - Benutzer sperren und entsperren
  - Zugriffsrechte zuweisen {{projectName}}
  - Profildaten exportieren
  - Benutzersitzungen beenden
  - Benutzerkennungen
  - Benutzer löschen {{projectName}}
...
# Benutzerverwaltung in {{projectName}}

In diesem Handbuch erfahren Sie, wie Sie Benutzerprofile in **{{projectName}}** erstellen und bearbeiten, Rollen und Zugriffsrechte zuweisen, Konten sperren und löschen, aktive Sitzungen beenden, den Datenschutz verwalten und Profildaten exportieren.
...
Die Liste aller in **{{projectName}}** registrierten Benutzer befindet sich im Bereich **Benutzer**. Hier können Administratoren Konten verwalten, Profile einsehen und den Systemzugriff steuern.
...
### Einen Benutzer in {{projectName}} erstellen

> 📌 In **{{projectName}}** gibt es mehrere Möglichkeiten, Benutzer zu registrieren: Selbstregistrierung über ein Widget und manuelle Erstellung durch einen Benutzer mit **Administrator**-Rechten.  
...
3. Das Benutzerprofil wird mit detaillierten Informationen geöffnet: Kontaktdaten, Kennungen und Datenschutzeinstellungen.
    ...
    <img src="./images/manage-user-01.webp" alt="Anzeigen eines Benutzerprofils in {{projectName}}" style="max-width:700px; width:100%">
...
Der Bereich **Kennungen** im Benutzerprofil zeigt die Login-Methoden an, die der Benutzer selbst hinzugefügt oder verwendet hat, um sich in der Anwendung oder im persönlichen **{{projectName}}**-Konto anzumelden. Der Administrator kann den Datenschutz einer Kennung konfigurieren und diese aus dem Benutzerprofil entfernen.
...
3. Klicken Sie auf dem Panel der Login-Methode, die Sie aus dem Profil entfernen möchten, auf **Löschen**.
    ...
    <img src="./images/manage-user-02.webp" alt="Löschen einer Kennung aus einem {{projectName}}-Benutzerprofil" style="max-width:600px; width:100%">
...
| **Auf Anfrage verfügbar** | ![Zugriff nach Genehmigung](./images/button-approve.webp) | Daten sind in Drittsystemen verfügbar, die mit **{{projectName}}** integriert sind. <br> Die Zustimmung des Benutzers ist für den Zugriff auf die Daten erforderlich. |
...
4. Wählen Sie eine neue Stufe aus dem Dropdown-Menü aus.
    ...
    <img src="./images/manage-user-03.webp" alt="Aktionsmenü zur Verwaltung von Benutzern und Rollen in {{projectName}}" style="max-width:600px; width:100%">  
...
3. Erweitern Sie den Block **Weitere Aktionen**.
    ...
    <img src="./images/manage-user-04.webp" alt="Herunterladen von Benutzerprofildaten in {{projectName}}" style="max-width:600px; width:100%">
...
2. Klicken Sie im Aktionsmenü des Benutzers auf **Sitzungen beenden**.  
    ...
    <img src="./images/manage-user-05.webp" alt="Beenden von Benutzersitzungen in der {{projectName}}-Benutzerliste" style="max-width:600px; width:100%">
...
2. Klicken Sie im Benutzerprofil innerhalb des Blocks **Weitere Aktionen** auf **Sitzungen beenden**.
    ...
    <img src="./images/manage-user-06.webp" alt="Beenden von Benutzersitzungen im {{projectName}}-Benutzerprofil" style="max-width:600px; width:100%">
...
{{projectName}} verwendet ein dreistufiges Zugriffssystem, das die Benutzerrechte klar definiert:
...
3. Wählen Sie die Aktion **Rechte ändern**.
    ...
    <img src="./images/manage-user-18.webp" alt="Zuweisen einer Benutzerrolle in der {{projectName}}-Benutzerliste" style="max-width:600px; width:100%">

4. Wählen Sie im sich öffnenden Fenster die Rolle **Manager** aus und klicken Sie auf **Speichern**.

    <img src="./images/manage-user-07.webp" alt="Dialog zur Auswahl von {{projectName}}-Benutzerberechtigungen" style="max-width:400px; width:100%">
...
### Benutzer in {{projectName}} sperren

Das Sperren verhindert den Zugriff auf alle Dienste, die **{{projectName}}** für den Login verwenden.
...
3. Bestätigen Sie die Aktion im Modal-Fenster.
    ...
    <img src="./images/manage-user-09.webp" alt="Bestätigungsdialog zum Sperren eines Benutzers in {{projectName}}" style="max-width:400px; width:100%">  

**Was nach dem Sperren passiert**:

- Der Status des Benutzers ändert sich zu **Gesperrt**.

    <img src="./images/manage-user-10.webp" alt="Status des gesperrten Benutzers in der {{projectName}}-Benutzerliste" style="max-width:600px; width:100%">
...
- Der gesperrte Benutzer kann sich nicht mehr beim Dienst oder bei Anwendungen anmelden.
    ...
    <img src="./images/manage-user-11.webp" alt="Beispiel für ein Login-Widget für einen gesperrten {{projectName}}-Benutzer" style="max-width:300px; width:100%">

### Benutzer in {{projectName}} entsperren
...
Ein Administrator kann einen Benutzer dauerhaft löschen. Sobald die Löschung bestätigt ist, verschwinden das Konto und alle Daten unwiderruflich. Der Benutzer verliert den Zugriff auf alle Anwendungen, in denen sein **{{projectName}}**-Konto verwendet wurde.
...
### So löschen Sie einen Benutzer in {{projectName}}
...
1. Klicken Sie in einer der Schnittstellen auf **Konto löschen**:
     ...
     - Im Aktionsmenü des Benutzers auf der Registerkarte **Benutzer**.  
        ...
        <img src="./images/manage-user-16.webp" alt="Benutzer-Aktionsmenü in {{projectName}}" style="max-width:600px; width:100%">

     - Im Benutzerprofil innerhalb des Blocks **Weitere Aktionen**.  

        <img src="./images/manage-user-15.webp" alt="Aktionsmenü im Benutzerprofil in {{projectName}}" style="max-width:600px; width:100%">
...
- [Organisationsverwaltung](./docs-02-box-system-install.md) — ein Handbuch zur Arbeit mit Organisationen in **{{projectName}}**.