---
title: "Integration von Rocket.Chat mit {{projectName}} — Einrichten von Single Sign-On"
description: "Erfahren Sie, wie Sie Single Sign-On in Rocket.Chat über {{projectName}} einrichten: einfache Konfiguration, Datenschutz und bequemer Zugriff für alle Unternehmensmitarbeiter."
keywords:
  - Integration Rocket.Chat mit {{projectName}}
  ...
  - Login bei Rocket.Chat über {{projectName}}
  - Konfiguration von Rocket.Chat mit {{projectName}}
  - Verbindung von Rocket.Chat mit {{projectName}}
...
# So konfigurieren Sie die Rocket.Chat-Integration mit {{projectName}}

In dieser Anleitung erfahren Sie, wie Sie Single Sign-On (SSO) in **Rocket.Chat** über das **{{projectName}}**-System einrichten.
...
Die Einrichtung des Logins über **{{projectName}}** besteht aus mehreren wichtigen Phasen, die in zwei verschiedenen Systemen durchgeführt werden:
...
4. Geben Sie die Verbindungsparameter an:
    ...
    - **URL** — Die URL des {{projectName}}-Dienstes. Zum Beispiel: `https://<{{projectName}} Installationsadresse>`
...
Nach Abschluss aller Schritte erscheint eine Login-Schaltfläche für **{{projectName}}** im **Rocket.Chat**-Autorisierungs-Widget.
...
2. Stellen Sie sicher, dass die Schaltfläche **Login with {{projectName}}** erschienen ist.
