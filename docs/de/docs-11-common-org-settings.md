---
title: "{{projectName}} Organisation — Verwaltung und Zugriffskonfiguration"
description: "Erfahren Sie, wie Sie eine Organisation in {{projectName}} einrichten: Erstellung, Branding, Zugriffsverwaltung, Anmeldemethoden und Prüfung der Benutzeraktivitäten."
keywords:
  - {{projectName}} Organisation
  - {{projectName}} Organisations-Dashboard
...
# Verwaltung einer Organisation in {{projectName}}

In **{{projectName}}** dienen Organisationen als primäre Struktureinheit für die Verwaltung des Anwendungszugriffs, die Unterteilung von Mitarbeitern nach Abteilungen und die Pflege von Audits der Benutzeraktivitäten. In diesem Leitfaden behandeln wir, wie Sie Organisationen erstellen und Anmeldemethoden konfigurieren.
...
Eine Organisation in **{{projectName}}** ist eine Struktureinheit, die es Ihnen ermöglicht:
...
### So greifen Sie auf das {{projectName}} Organisations-Dashboard zu
...
1. Melden Sie sich in Ihrem persönlichen **{{projectName}}**-Konto an.
...
3. Klicken Sie im sich öffnenden Mini-Widget-Fenster auf den Namen Ihrer Organisation.
    ...
    <img src="./images/org-settings-01.webp" alt="Auswahl einer Organisation im {{projectName}} Mini-Widget" style="max-width:300px; width:100%">
...
> <img src="./images/org-settings-02.webp" alt="Konfiguration der Anwendungsanzeige im {{projectName}} Mini-Widget" style="max-width:300px; width:100%">

## Konfiguration von Organisationsname und Logo { #organization-name-and-logo }

Der Name und das Logo werden sowohl in der Benutzeroberfläche des **{{projectName}}**-Systems als auch im Mini-Widget angezeigt.
...
5. Passen Sie den Anzeigeberich des Logos an.
    ...
    <img src="./images/settings-main-info-02.webp" alt="Konfiguration der Basisinformationen der Organisation in {{projectName}}" style="max-width:400px; width:100%">
...
- **Öffentliche Anmeldemethoden** verwenden, die vom **{{projectName}}**-Administrator konfiguriert wurden
...
> ⚠️ **Einschränkungen:** Nur **{{projectName}}**-Administratoren können öffentliche Anmeldemethoden bearbeiten.
