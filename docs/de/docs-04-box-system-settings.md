---
title: "Konfiguration von {{projectName}} — Sicherheit, Oberfläche und Zugriff"
description: "Erfahren Sie, wie Sie {{projectName}} konfigurieren: Benutzerzugriff, Oberfläche, E-Mail-Vorlagen und Monitoring via Sentry. Richten Sie Ihr System jetzt ein!"
keywords: 
  - {{projectName}} Konfiguration
  - {{projectName}} Zugriffseinrichtung
  - Lokalisierung 
  - Oberflächensprache 
...
# So konfigurieren Sie {{projectName}}: Sicherheit, Oberfläche und Zugriff

In dieser Anleitung erfahren Sie, wie Sie die Oberfläche und Lokalisierung von **{{projectName}}** konfigurieren, Anwendungstypen erstellen, den Benutzerzugriff verwalten, die Zwei-Faktor-Authentifizierung aktivieren und den Dienst zur Ereignisüberwachung in Sentry integrieren.

Dieser Abschnitt richtet sich an Administratoren und Sicherheitsspezialisten, die die Einstellungen von **{{projectName}}** effektiv verwalten möchten, einschließlich OAuth 2.0 und OpenID Connect.
...
Der Name und das Logo werden in der Oberfläche von **{{projectName}}** sowie im [Mini-Widget](./docs-09-common-mini-widget-settings.md) und im [Login-Widget](./docs-06-github-en-providers-settings.md#login-widget-settings) angezeigt.
...
2. Erweitern Sie den Block **Basisinformationen**.
    ...
    <img src="./images/settings-main-info-01.webp" alt="Konfiguration von {{projectName}} Name und Logo" style="max-width:600px; width:100%">
...
4. Klicken Sie im Block **Anwendungslogo** auf **Hochladen** und wählen Sie die Logodatei aus.
    ...
    <img src="./images/settings-main-info-02.webp" alt="Logo-Upload-Oberfläche in {{projectName}}" style="max-width:400px; width:100%">

    > ⚡ Unterstützte Formate: JPG, GIF, PNG, WEBP; maximale Größe 1 MB.

5. Konfigurieren Sie die Anzeige und klicken Sie auf **Anwenden**.

    <img src="./images/settings-main-info-03.webp" alt="Konfiguration der Logoanzeige in {{projectName}}" style="max-width:400px; width:100%">
...
**{{projectName}}** unterstützt die Oberfläche in **sechs Sprachen**:
...
Die gewählte Sprache beeinflusst die Textanzeige in allen Oberflächen von **{{projectName}}**, einschließlich des [Login-Widgets](./docs-06-github-en-providers-settings.md#login-widget-settings) und des [Mini-Widgets](./docs-09-common-mini-widget-settings.md).
...
2. Erweitern Sie den Block **Lokalisierung** und wählen Sie die gewünschte Sprache aus der Liste aus.
    ...
    <img src="./images/settings-localization-01.webp" alt="Konfiguration des Erscheinungsbilds des {{projectName}} Widgets" style="max-width:600px; width:100%">
...
**Mustache** ist eine einfache Template-Engine zum Einfügen von Daten in Textvorlagen. In **{{projectName}}** wird sie verwendet für:
...
3. Wählen Sie die gewünschte Vorlage aus und klicken Sie auf **Konfigurieren**.
    ...
    <img src="./images/settings-letters-templates-01.webp" alt="Auswahl einer E-Mail-Vorlage zur Bearbeitung in {{projectName}}" style="max-width:600px; width:100%">
...
4. Geben Sie im sich öffnenden Bearbeitungsformular Folgendes an:
    ...
    <img src="./images/settings-letters-templates-02.webp" alt="Bearbeiten einer HTML-E-Mail-Vorlage in {{projectName}}" style="max-width:600px; width:100%">
...
2. Erweitern Sie den Block **Zugriffseinstellungen** und klicken Sie auf **Konfigurieren**.
    ...
    <img src="./images/settings-access-01.webp" alt="2FA-Konfigurationsoberfläche in {{projectName}}" style="max-width:600px; width:100%">
...
3. Geben Sie die Anbieter für den ersten und zweiten Faktor an:
    ...
    <img src="./images/settings-access-02.webp" alt="Konfiguration von 2FA-Faktorkombinationen in {{projectName}}" style="max-width:600px; width:100%">
...
Standardmäßig prüft **{{projectName}}** bei der Autorisierung in Anwendungen das Vorhandensein aller erforderlichen Felder und kann den Login unterbrechen, bis der Benutzer die fehlenden Daten ausgefüllt hat. Die Einstellung **Pflichtfelder des Profils für Anwendungen ignorieren** ermöglicht es Ihnen, diese Prüfung zu deaktivieren.
...
| **Anwendungsadresse** | - | Basis-URL des **{{projectName}}**-Dienstes im Format `protokoll://domainname:port` |
...
Nach dem Erstellen des Projekts stellt **Sentry** einen **DSN (Data Source Name)** bereit — einen eindeutigen Identifikator zum Verbinden von **{{projectName}}** mit **Sentry**.
...
3. Geben Sie im sich öffnenden Verbindungsformular Folgendes an:
    ...
    - **Benutzer-ID** (falls erforderlich) — angeben, wenn Sie Fehler und Ereignisse nach bestimmten Benutzern verfolgen möchten.
      ...
      <img src="./images/settings-sentry-01.webp" alt="Konfiguration der Sentry-Verbindung in {{projectName}}" style="max-width:600px; width:100%">
...
4. Das Erstellungsformular wird geöffnet.
    ...
    <img src="./images/settings-app-type-01.webp" alt="Oberfläche zur Erstellung von Anwendungstypen in {{projectName}}" style="max-width:600px; width:100%">
...
3. Ein Fenster mit der Liste der Typen wird geöffnet.
    ...
    <img src="./images/settings-app-type-02.webp" alt="Dialog zur Erstellung von Anwendungstypen in {{projectName}}" style="max-width:600px; width:100%">
...
**Experimentelle Funktionen** sind neue Möglichkeiten des **{{projectName}}**-Dienstes, die sich in der Test- und Verfeinerungsphase befinden.
...
2. **Anwendungskatalog**
    ...
    - Zentralisierte Plattform für Anwendungen des **{{projectName}}**-Systems
    ...
    <img src="./images/personal-profile-22.webp" alt="Katalogoberfläche in {{projectName}}" style="max-width:400px; width:100%">
