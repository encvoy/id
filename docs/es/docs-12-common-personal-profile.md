...
<img src="./images/personal-profile-01.webp" alt="Botón para editar información básica en el perfil personal de Encvoy ID" style="max-width:700px; width:100%">
...
3. Realice los cambios necesarios en el formulario que se abre.
   ...
   >
   > <img src="./images/personal-profile-02.webp" alt="Ejemplo de validación del campo de correo electrónico en el formulario de edición de perfil de usuario de Encvoy ID" style="max-width:500px; width:100%">
...
4. Añada una foto utilizando uno de los siguientes métodos:
   - Haga clic en el botón **Cargar** y especifique la ruta al archivo de la foto,
       ...
       <img src="./images/personal-profile-03.webp" alt="Botón para subir una foto desde un dispositivo en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">

   - Haga clic en el botón **Disponibles** y seleccione una foto de un sistema externo.

       <img src="./images/personal-profile-04.webp" alt="Botón para seleccionar un avatar de servicios externos vinculados del usuario de Encvoy ID" style="max-width:600px; width:100%">
...
<img src="./images/personal-profile-05.webp" alt="Botón para editar el correo electrónico en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">

3. Se abrirá el formulario de adición.

<img src="./images/personal-profile-06.webp" alt="Edición de correo electrónico en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">
...
<img src="./images/personal-profile-07.webp" alt="Botón para editar el número de teléfono en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">

3. Se abrirá el formulario de edición.

<img src="./images/personal-profile-08.webp" alt="Edición de número de teléfono en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">
...
<img src="./images/personal-profile-09.webp" alt="Ubicación del botón de cambio de contraseña en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">

3. En la ventana que se abre, especifique la contraseña actual y la nueva contraseña.

<img src="./images/personal-profile-10.webp" alt="Diálogo de cambio de contraseña en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">
...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| **Disponible solo para usted** | ![Icono para acceso privado](./images/button-lock.webp "Icono para acceso privado")                          | Los datos no se transmiten a sistemas de terceros y están disponibles solo para usted.                                                     |
| **Disponible bajo petición**   | ![Icono para acceso por consentimiento](./images/button-approve.webp "Icono para acceso por consentimiento") | Los datos están disponibles en sistemas de terceros integrados con Encvoy ID. <br> Se requiere su consentimiento para acceder a los datos. |
| **Disponible para todos**      | ![Icono para acceso público](./images/button-public.webp "Icono para acceso público")                        | Los datos son siempre públicos. No se requiere su consentimiento para acceder a ellos.                                                     |
...
<img src="./images/personal-profile-11.webp" alt="Configuración de privacidad de campos en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">
...
<img src="./images/personal-profile-12.webp" alt="Botón para añadir un identificador en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">

3. En la ventana que se abre, seleccione un servicio externo.

<img src="./images/personal-profile-13.webp" alt="Adición de un identificador en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">
...
<img src="./images/personal-profile-14.webp" alt="Eliminación de un identificador en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">
...
4. Haga clic en el botón **Exportar vCard** ![Botón para descargar datos del perfil público](./images/button-export.webp "Botón para descargar datos del perfil público").
...
2. Active el interruptor **Perfil privado** en el bloque **Privacidad del perfil**.
   ...
   <img src="./images/personal-profile-15.webp" alt="Desactivación del perfil público en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">
...
2. En el bloque **Tarjeta de visita**, active el interruptor **Actividad**.
   ...
   <img src="./images/personal-profile-16.webp" alt="Activación de la tarjeta de presentación digital en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">
...
2. En el bloque **Tarjeta de visita**:
   - Haga clic en **Abrir código QR** ![Botón para abrir código QR](./images/button-qr.webp "Botón para abrir código QR") y escanee el código con la cámara de su dispositivo.
   - Haga clic en el botón **Copiar enlace** ![Botón para copiar dirección de la tarjeta](./images/button-link.webp "Botón para copiar dirección de la tarjeta") para copiar la dirección del enlace de la tarjeta.
...
<img src="./images/personal-profile-17.webp" alt="Diálogo de eliminación de cuenta en el perfil personal de Encvoy ID" style="max-width:600px; width:100%">
...
<img src="./images/personal-profile-18.webp" alt="Aplicación en la lista de permisos en el perfil personal de Encvoy ID" style="max-width:700px; width:100%">
...
<img src="./images/personal-profile-19.webp" alt="Menú de acciones de la aplicación en el perfil personal de Encvoy ID" style="max-width:700px; width:100%">
...
<img src="./images/personal-profile-21.webp" alt="Aceptar invitación desde el perfil de Encvoy ID" style="max-width:700px; width:100%">
...
1. Haga clic en el botón ![Botón para llamar al catálogo de aplicaciones](./images/button-catalog.webp "Botón para llamar al catálogo de aplicaciones").
2. Se abrirá una ventana con una lista de aplicaciones añadidas al catálogo.

<img src="./images/personal-profile-22.webp" alt="Catálogo de aplicaciones en el perfil personal de Encvoy ID" style="max-width:400px; width:100%">
...
1. Haga clic en el botón **Catálogo de aplicaciones** ![Botón para llamar al catálogo de aplicaciones](./images/button-catalog.webp "Botón para llamar al catálogo de aplicaciones").
2. Se abrirá una ventana con una lista de aplicaciones añadidas al catálogo.
3. Haga clic en el botón ![Botón para añadir una aplicación a favoritos](./images/button-bookmark-add.webp "Botón para añadir una aplicación a favoritos") situado junto a la aplicación que desea añadir a favoritos.

   La aplicación se añadirá a favoritos y se mostrará en el grupo correspondiente.

   <img src="./images/personal-profile-23.webp" alt="Aplicaciones favoritas en el perfil personal de Encvoy ID" style="max-width:400px; width:100%">

#### Eliminación de una Aplicación de Favoritos

1. Haga clic en el botón **Catálogo de aplicaciones** ![Botón para llamar al catálogo de aplicaciones](./images/button-catalog.webp "Botón para llamar al catálogo de aplicaciones").
2. Se abrirá una ventana con una lista de aplicaciones añadidas al catálogo.
3. Haga clic en el botón ![Botón para eliminar una aplicación de favoritos](./images/button-bookmark-added.webp "Botón para eliminar una aplicación de favoritos") situado junto a la aplicación que desea eliminar de favoritos.
