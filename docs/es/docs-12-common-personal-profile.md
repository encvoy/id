---
title: "{{projectName}} Perfil Personal — Gestión de Cuenta"
description: "Aprenda a configurar su perfil personal de {{projectName}}: edite datos y privacidad, gestione el acceso a aplicaciones y la seguridad de la cuenta."
keywords: 
  - {{projectName}} perfil personal
  - {{projectName}} cuenta personal
  - editar perfil {{projectName}}
  - configuración de perfil {{projectName}}
  - seguridad de cuenta {{projectName}}
  - cambiar contraseña {{projectName}}
  - permisos de aplicación OAuth
  - gestión de acceso a aplicaciones
  - eliminar cuenta {{projectName}}
  - borrar cuenta {{projectName}}
  - recuperación de cuenta {{projectName}}
...
# Cómo gestionar su Perfil Personal de {{projectName}}

**El Perfil de {{projectName}}** es su centro de control para los datos y la seguridad de su cuenta.

En esta guía, aprenderá a gestionar su perfil personal en **{{projectName}}**: editar datos y ajustes de privacidad, actualizar su contraseña, controlar el acceso a aplicaciones, ver el registro de actividad y exportar los datos del perfil.
...
<img src="./images/personal-profile-01.webp" alt="Botón para editar información básica en el perfil personal de {{projectName}}" style="max-width:700px; width:100%">
...
3. Realice los cambios necesarios en el formulario que se abre.
   ...
   >
   > <img src="./images/personal-profile-02.webp" alt="Ejemplo de validación del campo de correo electrónico en el formulario de edición de perfil de usuario de {{projectName}}" style="max-width:500px; width:100%">
...
4. Añada una foto utilizando uno de los siguientes métodos:
   - Haga clic en el botón **Cargar** y especifique la ruta al archivo de la foto,
       ...
       <img src="./images/personal-profile-03.webp" alt="Botón para subir una foto desde un dispositivo en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">

   - Haga clic en el botón **Disponibles** y seleccione una foto de un sistema externo.

       <img src="./images/personal-profile-04.webp" alt="Botón para seleccionar un avatar de servicios externos vinculados del usuario de {{projectName}}" style="max-width:600px; width:100%">
...
<img src="./images/personal-profile-05.webp" alt="Botón para editar el correo electrónico en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">

3. Se abrirá el formulario de adición.

<img src="./images/personal-profile-06.webp" alt="Edición de correo electrónico en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">
...
<img src="./images/personal-profile-07.webp" alt="Botón para editar el número de teléfono en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">

3. Se abrirá el formulario de edición.

<img src="./images/personal-profile-08.webp" alt="Edición de número de teléfono en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">
...
<img src="./images/personal-profile-09.webp" alt="Ubicación del botón de cambio de contraseña en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">

3. En la ventana que se abre, especifique la contraseña actual y la nueva contraseña.

<img src="./images/personal-profile-10.webp" alt="Diálogo de cambio de contraseña en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">
...
| **Disponible bajo petición**   | ![Icono para acceso por consentimiento](./images/button-approve.webp "Icono para acceso por consentimiento") | Los datos están disponibles en sistemas de terceros integrados con {{projectName}}. <br> Se requiere su consentimiento para acceder a los datos. |
...
<img src="./images/personal-profile-11.webp" alt="Configuración de privacidad de campos en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">
...
La lista de identificadores disponibles para añadir en el perfil se forma a partir de los métodos de inicio de sesión públicos creados en el panel de control de **{{projectName}}**.
...
<img src="./images/personal-profile-12.webp" alt="Botón para añadir un identificador en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">

3. En la ventana que se abre, seleccione un servicio externo.

<img src="./images/personal-profile-13.webp" alt="Adición de un identificador en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">
...
<img src="./images/personal-profile-14.webp" alt="Eliminación de un identificador en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">

El identificador será **eliminado inmediatamente** del perfil.

### Configuración del Perfil Público

**El Perfil Público** consiste en datos públicos disponibles para ser vistos por otros miembros del sistema **{{projectName}}** y aplicaciones conectadas. Le permite controlar qué información del usuario es visible para otros sin otorgar acceso total a la cuenta.
...
2. Active el interruptor **Perfil privado** en el bloque **Privacidad del perfil**.
   ...
   <img src="./images/personal-profile-15.webp" alt="Desactivación del perfil público en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">
...
**La Tarjeta de {{projectName}}** es un reemplazo digital moderno para una tarjeta de presentación de papel, accesible a través de un enlace único.
...
2. En el bloque **Tarjeta de visita**, active el interruptor **Actividad**.
   ...
   <img src="./images/personal-profile-16.webp" alt="Activación de la tarjeta de presentación digital en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">
...
**{{projectName}}** le permite exportar todos los datos del perfil en formato JSON.

Este archivo contiene toda la información relacionada con su perfil en **{{projectName}}**, así como detalles de las cuentas externas que ha añadido como métodos de inicio de sesión, independientemente de si el parámetro de privacidad está configurado para ellas.
...
Lea el documento sobre cómo **{{projectName}}** trata sus datos.
...
<img src="./images/personal-profile-17.webp" alt="Diálogo de eliminación de cuenta en el perfil personal de {{projectName}}" style="max-width:600px; width:100%">
...
Durante un período determinado después de la eliminación de la cuenta, tiene la oportunidad de restaurar el acceso a ella. Para ello, debe iniciar sesión nuevamente en la cuenta personal de **{{projectName}}**, luego hacer clic en **Restaurar Cuenta**.

> 💡 La recuperación de la cuenta solo está disponible al iniciar sesión en la cuenta personal de **{{projectName}}**. Al iniciar sesión en una aplicación a través del servicio **{{projectName}}**, la recuperación de la cuenta no está disponible.

---

## Permisos de Aplicaciones y Acceso OAuth { #app-permissions-and-oauth }

**Los Permisos** son los derechos que usted otorga a aplicaciones externas para acceder a datos específicos en su perfil de **{{projectName}}**. Puede restringir el acceso, finalizar sesiones activas o revocar permisos completamente en cualquier momento.
...
<img src="./images/personal-profile-18.webp" alt="Aplicación en la lista de permisos en el perfil personal de {{projectName}}" style="max-width:700px; width:100%">
...
<img src="./images/personal-profile-19.webp" alt="Menú de acciones de la aplicación en el perfil personal de {{projectName}}" style="max-width:700px; width:100%">
...
2. **En su perfil de {{projectName}}**: aparece una nueva invitación en la sección **Solicitudes**.
...
<img src="./images/personal-profile-21.webp" alt="Aceptar invitación desde el perfil de {{projectName}}" style="max-width:700px; width:100%">

Después de esto, el acceso a la aplicación se activará y podrá navegar hacia ella.

#### Si Aún No Tiene una Cuenta

Si recibió una invitación pero aún no está registrado en el sistema **{{projectName}}**:

1. Siga el enlace del correo de invitación.
2. Regístrese en el sistema **{{projectName}}**.
...
**El Catálogo** es un mercado centralizado para todas las aplicaciones disponibles en el ecosistema de **{{projectName}}**.
...
<img src="./images/personal-profile-22.webp" alt="Catálogo de aplicaciones en el perfil personal de {{projectName}}" style="max-width:400px; width:100%">

3. Seleccione la aplicación deseada en el catálogo.
4. Será redirigido automáticamente a la página de la aplicación.
5. Autentíquese en la aplicación usando **{{projectName}}** y otorgue a la aplicación acceso a sus datos.

Ahora puede iniciar sesión en la aplicación con su perfil de **{{projectName}}**.
...
3. Haga clic en el botón ![Botón para añadir una aplicación a favoritos](./images/button-bookmark-add.webp "Botón para añadir una aplicación a favoritos") situado junto a la aplicación que desea añadir a favoritos.
   ...
   <img src="./images/personal-profile-23.webp" alt="Aplicaciones favoritas en el perfil personal de {{projectName}}" style="max-width:400px; width:100%">
...
**El Registro de Actividad** es una herramienta de seguridad que le permite rastrear dónde y desde qué dispositivos inició sesión en **{{projectName}}** o en las aplicaciones.
