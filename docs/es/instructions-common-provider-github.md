---
title: "Inicio de sesión con GitHub — Conexión y configuración en {{projectName}}"
description: "Aprenda cómo habilitar el inicio de sesión con GitHub en {{projectName}}: cree un método de inicio de sesión y añádalo al widget de autorización. Conéctelo en solo unos pasos."
keywords: 
  - GitHub login 
...
# Cómo conectar el inicio de sesión con GitHub en {{projectName}}
...
En esta guía, aprenderá cómo conectar la autenticación utilizando una cuenta de **GitHub** al sistema **{{projectName}}**. Este método de inicio de sesión permite a los usuarios acceder a las aplicaciones utilizando su cuenta del servicio **GitHub**.
...
Antes de configurar el método de inicio de sesión en **{{projectName}}**, debe registrar su aplicación en la consola de desarrolladores de **GitHub** y obtener las claves de acceso:
