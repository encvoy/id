---
title: "Creación de una aplicación en {{projectName}} — OAuth/OIDC web y nativa"
description: "Aprenda a crear una aplicación en {{projectName}}: configuración del widget de autorización, métodos de inicio de sesión, envío de invitaciones y gestión de usuarios."
keywords: 
keywords:
  - creación de aplicación {{projectName}}
  - crear app {{projectName}}
...
# Cómo crear y configurar una aplicación en {{projectName}}

En esta guía, aprenderá a crear y configurar aplicaciones OAuth 2.0 y OIDC en **{{projectName}}**. Cubriremos en detalle la creación de aplicaciones web y nativas, la configuración del widget de inicio de sesión y la gestión de usuarios y accesos.
...
> **Aplicación Web** — una aplicación estándar que se ejecuta en el navegador del usuario e interactúa con **{{projectName}}** utilizando los protocolos OAuth 2.0 y OpenID Connect.
...
8. En el formulario de edición que se abre:
    ...
    - Seleccione `none` en los ajustes del método de autenticación.
      ...
      <img src="./images/app-settings-01.webp" alt="Creación de una aplicación OAuth nativa en {{projectName}}" style="max-width:600px; width:100%">
...
3. Haga clic en el panel de la aplicación cuyo perfil desea ver.
    ...
    <img src="./images/app-settings-02.webp" alt="Lista de aplicaciones OAuth en {{projectName}}" style="max-width:600px; width:100%">

4. Se abrirá el formulario del perfil de la aplicación.

    <img src="./images/app-settings-03.webp" alt="Visualización de una aplicación OAuth en {{projectName}}" style="max-width:600px; width:100%">
...
Tras la confirmación, la aplicación se eliminará de **{{projectName}}**.
...
3. En la ventana que se abre, especifique las direcciones de correo electrónico de los usuarios:
    ...
    <img src="./images/app-settings-05.webp" alt="Invitación de aplicación en {{projectName}}" style="max-width:500px; width:100%">
...
Los **Usuarios de la aplicación** (miembros) son usuarios del sistema **{{projectName}}** que han otorgado permiso a su aplicación para acceder a sus datos.

**Cómo un usuario se convierte en miembro:**

1. El usuario accede a su aplicación por primera vez.
2. El sistema lo redirige al widget de inicio de sesión de **{{projectName}}**.
...
> 💡 **Importante:** La gestión de miembros ocurre a nivel de **aplicación**. Las acciones no afectan la cuenta global de **{{projectName}}** del usuario, solo su conexión con la aplicación específica.
...
7. Se abrirá el perfil del usuario, que contiene una lista de los datos a los que el usuario ha otorgado acceso.
    ...
    <img src="./images/app-settings-06.webp" alt="Perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">
...
5. Abra el menú de acciones para el usuario cuyos permisos desea cambiar.
    ...
    <img src="./images/app-settings-07.webp" alt="Menú de acciones de usuario en {{projectName}}" style="max-width:600px; width:100%">

6. Seleccione la acción **Cambiar permisos**.
7. En la ventana que aparece, seleccione el nivel de permiso **Administrador**.

    <img src="./images/app-settings-08.webp" alt="Ventana de selección de permisos de usuario en {{projectName}}" style="max-width:400px; width:100%">
...
- La **cuenta global** del usuario en **{{projectName}}** permanece intacta.
...
1. Abra el menú de acciones para un usuario activo en el [perfil de la aplicación](./docs-10-common-app-settings.md#viewing-application).
    ...
    <img src="./images/manage-user-12.webp" alt="Bloqueo de un usuario en la lista de usuarios de {{projectName}}" style="max-width:600px; width:100%">

2. Seleccione la acción **Bloquear en {{projectName}}**.
3. Confirme la acción en la ventana modal.

    <img src="./images/manage-user-09.webp" alt="Diálogo de confirmación de bloqueo de usuario en {{projectName}}" style="max-width:400px; width:100%">  
...
### Desbloqueo de usuarios de {{projectName}}
...
2. Seleccione la acción **Desbloquear en {{projectName}}**.
3. Confirme la acción en la ventana modal.
...
| **Descripción de la aplicación** | Descripción corta mostrada en la interfaz del servicio **{{projectName}}** | Texto (hasta 255 caracteres) | ✗ |
| **Logotipo de la aplicación** | Se muestra en la interfaz del servicio **{{projectName}}** y en el widget de inicio de sesión | Imagen en formato JPG, GIF, PNG, WEBP. Tamaño máx. - 1 MB. | ✗ |
...
Parámetros técnicos que afectan la interacción de la aplicación con **{{projectName}}**.
...
| **Dirección de la aplicación** | - | URL del recurso web donde se utilizará el inicio de sesión a través de **{{projectName}}** | Texto en formato `protocolo://nombre-de-dominio:puerto` | ✓ |
...
- [Gestión de Organizaciones](./docs-09-common-mini-widget-settings.md) — guía para trabajar con las organizaciones del sistema **{{projectName}}**.
