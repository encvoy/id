---
title: "{{projectName}} Métodos de inicio de sesión — Conexión y configuración"
description: "Aprenda a configurar los métodos de inicio de sesión y el widget de autorización en {{projectName}}. Conexión rápida de proveedores OAuth, WebAuthn, mTLS, HOTP y TOTP con ejemplos."
keywords: 
  - {{projectName}} login methods
  - SSO authorization
...
### Tipos de proveedores de autenticación en {{projectName}}

**{{projectName}}** admite los siguientes tipos de métodos de inicio de sesión:
...
Los métodos de inicio de sesión se pueden crear en diferentes tipos de paneles de **{{projectName}}**:
...
Para los servicios más populares, **{{projectName}}** proporciona plantillas listas para usar con configuraciones. Estas simplifican el proceso de conexión, ya que contienen parámetros pre-completados específicos para cada proveedor.
...
2. **Configuración en {{projectName}}:** cree un proveedor del tipo correspondiente.
...
4. Haga clic en el botón **Configurar** en el panel del método de inicio de sesión que desea editar.
    ...
    <img src="./images/settings-provider-01.webp" alt="Edición de un método de inicio de sesión en {{projectName}}" style="max-width:500px; width:100%">
...
5. Haga clic en el botón **Eliminar** ![Botón Eliminar](./images/button-delete.webp "Botón Eliminar") ubicado en el panel del método de inicio de sesión que desea eliminar.
    ...
    <img src="./images/settings-provider-02.webp" alt="Eliminación de un método de inicio de sesión en {{projectName}}" style="max-width:500px; width:100%">

6. Confirme la acción en la ventana modal.  

    <img src="./images/settings-provider-03.webp" alt="Confirmación de eliminación del método de inicio de sesión en {{projectName}}" style="max-width:400px; width:100%">
...
1. Copie la configuración del método de inicio de sesión utilizando el botón **Copiar** ![Botón Copiar](./images/button-copy.webp "Botón Copiar") ubicado en el panel del método de inicio de sesión.
    ...
    <img src="./images/settings-provider-04.webp" alt="Copia de la configuración del método de inicio de sesión en {{projectName}}" style="max-width:500px; width:100%">  
...
La lista de identificadores disponibles para añadir se forma a partir de los métodos de inicio de sesión en el panel de **{{projectName}}** con un ajuste de publicidad activo.
...
En **{{projectName}}**, puede configurar el requisito de vinculación obligatoria de un identificador de cuenta externa al perfil de usuario. En este caso, al iniciar sesión en la aplicación, un usuario que no tenga un identificador vinculado verá una solicitud para añadir uno a su perfil.
...
4. Haga clic en el botón **Hacer obligatorio** ![Botón Hacer Obligatorio](./images/button-required.webp "Botón Hacer Obligatorio") en el panel del método de inicio de sesión que desea hacer obligatorio.
    ...
    <img src="./images/settings-provider-05.webp" alt="Método de inicio de sesión obligatorio en el perfil de usuario de {{projectName}}" style="max-width:500px; width:100%">
...
El **Widget de inicio de sesión** es el formulario de autorización que se muestra al usuario cuando intenta iniciar sesión en una aplicación o en el sistema **{{projectName}}** si aún no está autenticado.
...
<img src="./images/settings-provider-06.webp" alt="Ejemplo de widget de inicio de sesión de {{projectName}}" style="max-width:400px; width:100%">
...
5. En el segundo bloque, configure la visibilidad de los elementos del formulario de inicio de sesión:
    ...
    - **Ocultar logotipos de los principales métodos de inicio de sesión** — Cuando está habilitado, oculta los logotipos de los métodos de inicio de sesión del grupo **Principal**.
      ...
      <img src="./images/settings-provider-07.webp" alt="Configuración de la apariencia del widget de inicio de sesión de {{projectName}}" style="max-width:300px; width:100%">
...
6. En el tercer bloque, configure el diseño de los botones:
    ...
    - **Color de fuente en los botones** — Esquema de color para el texto del botón (código hex).
      ...
      <img src="./images/settings-provider-08.webp" alt="Configuración del diseño de los botones del widget de {{projectName}}" style="max-width:300px; width:100%">
...
7. Si es necesario, especifique el texto:
    ...
    - **Campo adicional fuera del widget** — Texto adicional que se mostrará debajo del widget.
      ...
      <img src="./images/settings-provider-09.webp" alt="Configuración de texto adicional en el widget de inicio de sesión de {{projectName}}" style="max-width:600px; width:100%">
...
- [Gestión de la organización](./docs-02-box-system-install.md) — guía para trabajar con una organización en **{{projectName}}**.
