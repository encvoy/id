---
title: "Configuración del perfil de usuario de {{projectName}} — Contraseña y campos"
description: "Aprenda a configurar el perfil de usuario de {{projectName}}: contraseña, campos básicos y adicionales, validación de datos, confirmación de correo electrónico y teléfono."
keywords:
keywords:
  - configuración del perfil de usuario de {{projectName}}
  - perfil de usuario de {{projectName}}
  - ajustes de usuario de {{projectName}}
  - gestión de perfiles de {{projectName}}
  - política de contraseñas de {{projectName}}
  - configuración de política de contraseñas
  - requisitos de contraseña
  - validación de campos de perfil de usuario
  - reglas de validación de {{projectName}}
...
# Cómo configurar el perfil de usuario de {{projectName}}

En esta guía, explicaremos cómo configurar el perfil de usuario y la política de contraseñas en **{{projectName}}**. Aprenderá a gestionar los campos del perfil, la validación de campos y a configurar la confirmación de la dirección de correo electrónico y el número de teléfono.
...
La **política de contraseñas en {{projectName}}** es un conjunto de reglas que definen los requisitos de complejidad y seguridad para las contraseñas de los usuarios. Ayuda a proteger las cuentas contra el hackeo y el acceso no autorizado.
...
2. Despliegue el bloque **Configuración del perfil de usuario** y haga clic en el panel **Contraseña**.
    ...
    <img src="./images/settings-user-profile-01.webp" alt="Configuración de las reglas de la política de contraseñas de usuario en {{projectName}}" style="max-width:600px; width:100%">

3. En la ventana que aparece, haga clic en **Configurar**.

    <img src="./images/settings-user-profile-02.webp" alt="Bloque de configuración de reglas de validación en {{projectName}}" style="max-width:600px; width:100%">
...
5. Marque las casillas de las reglas que desea aplicar a la contraseña.  
    ...
    <img src="./images/settings-user-profile-03.webp" alt="Selección de reglas de validación de contraseña en {{projectName}}" style="max-width:600px; width:100%">  
...
<img src="./images/settings-user-profile-04.webp" alt="Vista rápida de la configuración de campos en {{projectName}}" style="max-width:600px; width:100%">
...
3. Haga clic en el panel del campo que necesita configurar.
    ...
    <img src="./images/settings-user-profile-05.webp" alt="Configuración de campos básicos del perfil de usuario en {{projectName}}>" style="max-width:600px; width:100%">
...
<img src="./images/settings-user-profile-06.webp" alt="Configuración de un campo adicional del perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">
...
3. Haga clic en el botón **Eliminar** ![Botón eliminar](./images/button-delete.webp "Botón eliminar") junto al campo que desea eliminar.  
    ...
    <img src="./images/settings-user-profile-07.webp" alt="Eliminar un campo adicional del perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">
...
<img src="./images/settings-user-profile-08.webp" alt="Visualización de las reglas de validación de campos de perfil de usuario definidas en {{projectName}}" style="max-width:600px; width:100%">
...
3. Haga clic en el panel con la contraseña, el campo básico o el adicional.  
    ...
    <img src="./images/settings-user-profile-01.webp" alt="Bloque de configuración de política de contraseñas en {{projectName}}" style="max-width:600px; width:100%">

4. Se abrirá el formulario de edición.
5. Haga clic en **Configurar** en la sección **Reglas de validación**.

    <img src="./images/settings-user-profile-02.webp" alt="Bloque de configuración de reglas de validación para campos de perfil en {{projectName}}" style="max-width:600px; width:100%">
...
7. Se abrirá el formulario de creación de reglas.
    ...
    <img src="./images/settings-user-profile-10.webp" alt="Formulario de creación de reglas de validación de campos de perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">
...
7. En el panel de la regla, haga clic en el botón **Eliminar** ![Botón eliminar](./images/button-delete.webp "Botón eliminar").  
    ...
    <img src="./images/settings-user-profile-12.webp" alt="Eliminar una regla de validación para campos de perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">
...
5. Haga clic en **Configurar** en la sección **Reglas de validación**.
    ...
    <img src="./images/settings-user-profile-02.webp" alt="Bloque de configuración de reglas de validación en un campo de perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">

6. Se abrirá la ventana de la lista de reglas de validación.

    <img src="./images/settings-user-profile-03.webp" alt="Lista de reglas de validación en un campo de perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">
...
La **confirmación de correo electrónico en {{projectName}}** es un mecanismo para verificar la validez de la dirección proporcionada por el usuario durante el registro, la autorización o la modificación de los datos del perfil.
...
5. En la sección **Configuración de verificación de correo electrónico**, haga clic en **Agregar**.
    ...
    <img src="./images/settings-user-profile-14.webp" alt="Añadir ajustes de confirmación de correo electrónico para un perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">
...
6. En la ventana que se abre, especifique los parámetros:
    ...
    | **Imagen del correo** | Icono que se mostrará en la interfaz del servicio **{{projectName}}** |
...
5. En la sección **Configuración de verificación de correo electrónico**, haga clic en el botón **Configurar**.
    ...
    <img src="./images/settings-user-profile-15.webp" alt="Editar ajustes de confirmación de correo electrónico para un perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">
...
5. Haga clic en el botón **Eliminar** ![Botón eliminar](./images/button-delete.webp "Botón eliminar") en la sección **Configuración de verificación de correo electrónico**.
    ...
    <img src="./images/settings-user-profile-16.webp" alt="Eliminar ajustes de confirmación de correo electrónico para un perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">

6. Confirme la acción en la ventana modal.

    <img src="./images/settings-user-profile-17.webp" alt="Diálogo para eliminar ajustes de confirmación de correo electrónico para un perfil de usuario en {{projectName}}" style="max-width:400px; width:100%">

---

## Ajustes de confirmación de número de teléfono { #phone-confirmation-settings }

La **confirmación de número de teléfono en {{projectName}}** es un mecanismo para verificar la validez del número de contacto proporcionado por el usuario durante el registro, el inicio de sesión o la modificación del perfil.
...
En la versión actual de **{{projectName}}**, la confirmación de número se implementa mediante la integración con el servicio [Call Authorization](https://kloud.one/id/) de la plataforma **Kloud.One**. Para que este mecanismo funcione, debe configurar la conexión a **Kloud.One** especificando el ID de cliente y el secreto.
...
5. En la sección **Configuración de verificación de número de teléfono**, haga clic en **Agregar**.
    ...
    <img src="./images/settings-user-profile-18.webp" alt="Añadir ajustes de confirmación de número de teléfono para un perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">
...
6. En la ventana que aparece, establezca los parámetros necesarios:
    ...
    | **Imagen del teléfono** | - | Icono que se mostrará en la interfaz del servicio **{{projectName}}** |
...
5. Haga clic en el botón **Eliminar** ![Botón eliminar](./images/button-delete.webp "Botón eliminar") en la sección **Configuración de verificación de número de teléfono**.
    ...
    <img src="./images/settings-user-profile-19.webp" alt="Eliminar ajustes de confirmación de número de teléfono para un perfil de usuario en {{projectName}}" style="max-width:600px; width:100%">

6. Confirme la acción en la ventana modal.

    <img src="./images/settings-user-profile-17.webp" alt="Diálogo para eliminar ajustes de confirmación de número de teléfono para un perfil de usuario en {{projectName}}" style="max-width:400px; width:100%">
