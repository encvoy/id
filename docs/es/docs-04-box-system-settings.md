---
title: "Configuración de {{projectName}} — seguridad, interfaz y acceso"
description: "Aprenda a configurar {{projectName}}: acceso de usuarios, interfaz, plantillas de correo electrónico y monitoreo a través de Sentry. ¡Configure su sistema ahora!"
keywords: 
  - configuración de {{projectName}}
  - configuración de acceso {{projectName}}
  - localización 
...
# Cómo configurar {{projectName}}: Seguridad, Interfaz y Acceso

En esta guía, aprenderá a configurar la interfaz y localización de **{{projectName}}**, crear tipos de aplicaciones, gestionar el acceso de usuarios, habilitar la autenticación de dos factores e integrar el servicio con Sentry para el monitoreo de eventos.

Esta sección está dirigida a administradores y especialistas en seguridad que desean gestionar eficazmente los ajustes de **{{projectName}}**, incluyendo OAuth 2.0 y OpenID Connect.
...
El nombre y el logotipo se muestran en la interfaz de **{{projectName}}**, así como en el [mini-widget](./docs-09-common-mini-widget-settings.md) y el [widget de inicio de sesión](./docs-06-github-en-providers-settings.md#login-widget-settings).
...
2. Despliegue el bloque **Información principal**.
    ...
    <img src="./images/settings-main-info-01.webp" alt="Configuración del nombre y logotipo de {{projectName}}" style="max-width:600px; width:100%">
...
4. En el bloque **Logotipo de la aplicación**, haga clic en **Cargar** y seleccione el archivo del logotipo.
    ...
    <img src="./images/settings-main-info-02.webp" alt="Interfaz de carga de logotipo en {{projectName}}" style="max-width:400px; width:100%">

    > ⚡ Formatos compatibles: JPG, GIF, PNG, WEBP; tamaño máximo 1 MB.

5. Configure la visualización y haga clic en **Aplicar**.

    <img src="./images/settings-main-info-03.webp" alt="Configuración de visualización de logotipo en {{projectName}}" style="max-width:400px; width:100%">
...
**{{projectName}}** admite la interfaz en **seis idiomas**:
...
El idioma seleccionado afecta la visualización del texto en todas las interfaces de **{{projectName}}**, incluyendo el [widget de inicio de sesión](./docs-06-github-en-providers-settings.md#login-widget-settings) y el [mini-widget](./docs-09-common-mini-widget-settings.md).
...
2. Despliegue el bloque **Localización** y seleccione el idioma requerido de la lista.
    ...
    <img src="./images/settings-localization-01.webp" alt="Configuración de la apariencia del widget de {{projectName}}" style="max-width:600px; width:100%">
...
**Mustache** es un motor de plantillas sencillo para insertar datos en plantillas de texto. En **{{projectName}}**, se utiliza para:
...
3. Seleccione la plantilla requerida y haga clic en **Configurar**.
    ...
    <img src="./images/settings-letters-templates-01.webp" alt="Selección de una plantilla de correo para editar en {{projectName}}" style="max-width:600px; width:100%">
...
4. En el formulario de edición que se abre, especifique:
    ...
    <img src="./images/settings-letters-templates-02.webp" alt="Edición de plantilla de correo HTML en {{projectName}}" style="max-width:600px; width:100%">
...
2. Despliegue el bloque **Configuración de acceso** y haga clic en **Configurar**.
    ...
    <img src="./images/settings-access-01.webp" alt="Interfaz de configuración de 2FA en {{projectName}}" style="max-width:600px; width:100%">
...
3. Especifique los proveedores del primer y segundo factor:
    ...
    <img src="./images/settings-access-02.webp" alt="Configuración de combinaciones de factores 2FA en {{projectName}}" style="max-width:400px; width:100%">
...
| **Dirección de la aplicación** | - | URL base del servicio **{{projectName}}** en formato `protocolo://nombre_dominio:puerto` |
...
Después de crear el proyecto, **Sentry** proporcionará un **DSN (Data Source Name)** — un identificador único para conectar **{{projectName}}** a **Sentry**.
...
3. En el formulario de conexión que se abre, especifique:
    ...
    - **ID de usuario** (si es necesario) — especifique si necesita rastrear errores y eventos por usuarios específicos.
      ...
      <img src="./images/settings-sentry-01.webp" alt="Configuración de la conexión de Sentry en {{projectName}}" style="max-width:600px; width:100%">
...
4. Se abrirá el formulario de creación.
    ...
    <img src="./images/settings-app-type-01.webp" alt="Interfaz de creación de tipo de aplicación en {{projectName}}" style="max-width:600px; width:100%">
...
3. Se abrirá una ventana con la lista de tipos.
    ...
    <img src="./images/settings-app-type-02.webp" alt="Diálogo de creación de tipo de aplicación en {{projectName}}" style="max-width:600px; width:100%">
...
Las **funciones experimentales** son nuevas capacidades del servicio **{{projectName}}** que se encuentran en etapa de prueba y refinamiento.
...
2. **Catálogo de Aplicaciones**
    ...
    - Plataforma centralizada para las aplicaciones del sistema **{{projectName}}**
    ...
    <img src="./images/personal-profile-22.webp" alt="Interfaz del catálogo en {{projectName}}" style="max-width:400px; width:100%">
