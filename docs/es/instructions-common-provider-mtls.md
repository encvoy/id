---
title: "Inicio de sesión mTLS — Conexión en {{projectName}}"
description: "Aprenda a habilitar el inicio de sesión mTLS en {{projectName}}: cree un método de inicio de sesión y añádalo al widget de autorización. Conéctese en solo unos pasos."
keywords: 
  ...
  - configuración mTLS
  - mTLS {{projectName}}
  - iniciar sesión mediante mTLS {{projectName}}
  - configurar mTLS en {{projectName}}
date: 2025-12-12
updated: 2025-12-22
product: [box, github]
region: [ru, en]
...
# Cómo conectar el inicio de sesión mTLS en {{projectName}}
...
En esta guía, aprenderá cómo conectar la autenticación **mTLS** al sistema **{{projectName}}**.

La configuración del inicio de sesión mediante **mTLS** consta de varias etapas clave:

1. Configuración de la autenticación mTLS para administradores de **{{projectName}}**
...
2. Vinculación de un certificado de cliente para usuarios de **{{projectName}}**
...
1. **Inicio de la conexión:** El cliente envía una solicitud al servidor de **{{projectName}}**.
...
## Configuración de la autenticación mTLS para administradores de {{projectName}}
...
- crear y activar el proveedor **mTLS** en la interfaz de **{{projectName}}**;
- instalar certificados de cliente en los dispositivos de los usuarios.

### Paso 1. Configurar Nginx para mTLS { #step-1-configure-nginx-for-mtls }

Antes de añadir el proveedor en **{{projectName}}**, debe preparar la configuración de **Nginx**:
...
## Vinculación de un certificado de cliente para usuarios de {{projectName}}
...
- [Gestión de la organización](./docs-09-common-mini-widget-settings.md) — guía sobre el trabajo con organizaciones en el sistema **{{projectName}}**.
