---
title: "Integración de Nextcloud con {{projectName}} — Configuración de Single Sign-On"
description: "Aprenda a configurar el inicio de sesión único (Single Sign-On) en Nextcloud a través de {{projectName}}: configuración sencilla, protección de datos y acceso cómodo para todos los empleados de la empresa."
keywords:
  - integración de Nextcloud con {{projectName}}
  ...
  - OIDC Nextcloud
  - iniciar sesión en Nextcloud a través de {{projectName}}
  - configuración de Nextcloud con {{projectName}}
  - conectar Nextcloud a {{projectName}}
...
# Cómo configurar la integración de Nextcloud con {{projectName}}

En esta guía, aprenderá a configurar el inicio de sesión único (SSO) en **Nextcloud** utilizando el sistema **{{projectName}}**.
...
La configuración del inicio de sesión con **{{projectName}}** consta de dos etapas clave realizadas en dos sistemas diferentes.
...
1. Inicie sesión en **{{projectName}}**.  
...
5. Complete los parámetros de conexión:
    ...
    - **Authorize url** - especifique la URL de autorización. Por ejemplo, `https://<{{projectName}}-installation-address>/api/oidc/auth`.
    - **URL token** - especifique la URL para obtener el token de acceso. Por ejemplo, `https://<{{projectName}}-installation-address>/api/oidc/token`.
...
Después de completar todos los pasos, el botón de inicio de sesión para **{{projectName}}** se mostrará en el widget de autorización de **Nextcloud**.
...
2. Asegúrese de que haya aparecido el botón **Login with {{projectName}}**.
