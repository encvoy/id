---
title: "User Management in {{projectName}} — Administrator Guide"
description: "Learn how to manage users in {{projectName}}: creation and editing, blocking and deletion, access control, and privacy management."
keywords: 
  - user management {{projectName}}
  - create user {{projectName}}
  - edit user profile
  - block and unblock user
  - assign access rights {{projectName}}
  - export profile data
  - terminate user sessions
  - user identifiers
  - delete user {{projectName}}
...
# User Management in {{projectName}}

In this guide, you will learn how to create and edit user profiles in **{{projectName}}**, assign roles and access rights, block and delete accounts, terminate active sessions, manage privacy, and export profile data.
...
The list of all users registered in **{{projectName}}** is located in the **Users** section. Here, administrators can manage accounts, view profiles, and control system access.

> ⚠️ **Access Requirements**: This section is available in the admin panel for users with **Administrator** system permissions.

### Creating a User in {{projectName}}

> 📌 In **{{projectName}}**, there are several ways to register users: self-registration via a widget and manual creation by a user with **Administrator** rights.  
...
3. The user profile will open with detailed information: contact details, identifiers, and privacy settings.
    ...
    <img src="./images/manage-user-01.webp" alt="Viewing a user profile in {{projectName}}" style="max-width:700px; width:100%">
...
The **Identifiers** section of the user profile displays the login methods that the user added themselves or used to log into the application or the **{{projectName}}** personal account. The administrator can configure the privacy of an identifier and remove it from the user profile.
...
3. Click **Delete** on the panel of the login method you want to remove from the profile.
    ...
    <img src="./images/manage-user-02.webp" alt="Deleting an identifier from a {{projectName}} user profile" style="max-width:600px; width:100%">
...
| **Available on request** | ![Access by approval](./images/button-approve.webp) | Data is available in third-party systems integrated with **{{projectName}}**. <br> User consent is required to access the data. |
...
4. Select a new level from the dropdown menu.
    ...
    <img src="./images/manage-user-03.webp" alt="Action menu for managing users and roles in {{projectName}}" style="max-width:600px; width:100%">  
...
3. Expand the **Other Actions** block.
    ...
    <img src="./images/manage-user-04.webp" alt="Downloading user profile data in {{projectName}}" style="max-width:600px; width:100%">
...
2. Click **End Sessions** in the user action menu.  
    ...
    <img src="./images/manage-user-05.webp" alt="Terminating user sessions in the {{projectName}} user list" style="max-width:600px; width:100%">
...
2. Click **End Sessions** in the user profile within the **Other Actions** block.
    ...
    <img src="./images/manage-user-06.webp" alt="Terminating user sessions in the {{projectName}} user profile" style="max-width:600px; width:100%">
...
{{projectName}} uses a three-level access system that clearly defines user rights:
...
3. Select the **Change Permissions** action.
    ...
    <img src="./images/manage-user-18.webp" alt="Assigning a user role in the {{projectName}} user list" style="max-width:600px; width:100%">

4. In the window that opens, select the **Manager** role and click **Save**.

    <img src="./images/manage-user-07.webp" alt="Dialog for selecting {{projectName}} user permissions" style="max-width:400px; width:100%">
...
### Blocking {{projectName}} Users

Blocking prevents access to all services that use **{{projectName}}** for login.
...
3. Confirm the action in the modal window.
    ...
    <img src="./images/manage-user-09.webp" alt="Confirmation dialog for blocking a user in {{projectName}}" style="max-width:400px; width:100%">  

**What Happens After Blocking**:

- The user's status will change to **Blocked**.

    <img src="./images/manage-user-10.webp" alt="Blocked user status in the {{projectName}} user list" style="max-width:600px; width:100%">
...
- The blocked user will not be able to log into the service or applications.
    ...
    <img src="./images/manage-user-11.webp" alt="Example login widget for a blocked {{projectName}} user" style="max-width:300px; width:100%">
...
An administrator can permanently delete a user. Once deletion is confirmed, the account and all data will disappear irrevocably. The user will lose access to all applications where their **{{projectName}}** account was used.
...
### How to Delete a {{projectName}} User
...
1. Click **Delete account** in one of the interfaces:
     ...
     - In the user action menu on the **Users** tab.  
        ...
        <img src="./images/manage-user-16.webp" alt="{{projectName}} user action menu" style="max-width:600px; width:100%">

     - In the user profile within the **Other Actions** block.  

        <img src="./images/manage-user-15.webp" alt="{{projectName}} user profile action menu" style="max-width:600px; width:100%">
...
- [Organization Management](./docs-02-box-system-install.md) — a guide to working with organizations in **{{projectName}}**.
