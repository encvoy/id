---
title: "GitHub Login — Connection and Configuration in {{projectName}}"
description: "Learn how to enable GitHub login in {{projectName}}: create a login method and add it to the authorization widget. Connect in just a few steps."
keywords: 
  - GitHub login 
...
# How to Connect GitHub Login in {{projectName}}
...
In this guide, you will learn how to connect authentication using a **GitHub** account to the **{{projectName}}** system. This login method allows users to sign in to applications using their **GitHub** service account.
...
Before configuring the login method in **{{projectName}}**, you must register your application in the **GitHub** developer console and obtain access keys:
