---
title: "Registration in {{projectName}} — login and password recovery"
description: "Learn how to register in {{projectName}}, create an account, and recover your password. Follow the step-by-step guide and start using the service!"
keywords:
  - registration in {{projectName}}
  - register in {{projectName}}
  - account creation {{projectName}}
  - login to {{projectName}}
  - sign in to {{projectName}}
  - password recovery {{projectName}}
  - reset password {{projectName}}
  - OAuth login to {{projectName}}
  - social login {{projectName}}
  - authentication {{projectName}}
  - authorization {{projectName}}
...
# Registration, Login, and Password Recovery in {{projectName}}

In this guide, you will learn how to create an account in **{{projectName}}**, log in using a username and password or via external services, and securely recover access to your profile if necessary.
...
<img src="./images/user-auth-01.webp" alt="Account creation button in the {{projectName}} login widget" style="max-width:400px; width:100%">

2. **On the action selection form when logging in via a login method**, if the specified identifier is not linked to any profile in **{{projectName}}**

<img src="./images/user-auth-02.webp" alt="Account creation button in the {{projectName}} action selection widget" style="max-width:400px; width:100%">

> 💡 **Form design** may vary depending on the settings of the specific application

### How to Create an Account in {{projectName}}
...
2. Enter the required data in the registration form.
   ...
   <img src="./images/user-auth-03.webp" alt="Form for entering username during registration in the {{projectName}} widget" style="max-width:400px; width:100%">
...
4. Enter the code or follow the link from the email sent to the specified address.
   ...
   <img src="./images/user-auth-04.webp" alt="Adding an email address in the {{projectName}} widget" style="max-width:400px; width:100%">
...
You can authorize in the application using your **{{projectName}}** account.
...
2. Enter your password at the second step and click **Log in**.
   ...
   <img src="./images/user-auth-06.webp" alt="Password entry in the {{projectName}} login widget" style="max-width:400px; width:100%">
...
- upon the first login, a data access confirmation form will open;
  ...
  Example of a form requesting access to profile data:
    ...
    <img src="./images/user-auth-07.webp" alt="Profile data access request in the {{projectName}} login widget" style="max-width:400px; width:100%">
...
- if the application requires mandatory profile fields, the system will request them to be filled in;
  ...
  Example of a phone number request:
    ...
    <img src="./images/user-auth-08.webp" alt="Field completion request in the {{projectName}} login widget" style="max-width:400px; width:100%">
...
- if data is hidden by [privacy settings](./docs-12-common-personal-profile.md#privacy-levels), you will be prompted to change the access level.
  ...
  Example of changing birth date privacy:
    ...
    <img src="./images/user-auth-09.webp" alt="Birth date privacy change request in the {{projectName}} login widget" style="max-width:400px; width:100%">
...
<img src="./images/user-auth-10.webp" alt="Login methods in the {{projectName}} login widget" style="max-width:400px; width:100%">
...
If you have already logged into **{{projectName}}** in your browser, re-authorization will not be required.

1. Upon entry, a window for selecting a saved account will open.
2. Click on the username.

<img src="./images/user-auth-11.webp" alt="{{projectName}} account selection widget" style="max-width:400px; width:100%">
...
If you have forgotten the password for your **{{projectName}}** account, you can easily recover it.

### How to Recover a Password in {{projectName}}

1. At the first step of the login widget, enter your identification data (e.g., username, e-mail, or phone number) and click **Log in**.
2. At the next step, select **Recover password**.

<img src="./images/user-auth-12.webp" alt="Account password recovery button in the {{projectName}} login widget" style="max-width:400px; width:100%">
...
4. Enter the code from the email.
   ...
   <img src="./images/user-auth-13.webp" alt="Entering code during password recovery in the {{projectName}} login widget" style="max-width:400px; width:100%">
