---
title: "OpenID Connect Login — Connecting in {{projectName}}"
description: "Learn how to enable OpenID Connect login in {{projectName}}: create a login method and add it to the authorization widget. Connect in just a few steps."
keywords: 
  ...
  - configure OpenID Connect in {{projectName}}
  - connect OpenID Connect to {{projectName}}
...
# How to Connect OpenID Connect Login in {{projectName}}
...
In this guide, you will learn how to connect **OpenID Connect** authentication to the **{{projectName}}** system.
...
2. Copy the values of the **Application ID/Client ID** and **Secret/Client Secret** fields. You will need them when creating the application in **{{projectName}}**.
...
| **Redirect URI** (non-editable) | `redirect URI` | The **{{projectName}}** address where the user is redirected after authentication in the third-party service |
