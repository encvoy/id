---
title: "Email Login in {{projectName}} — Email Configuration"
description: "Learn how to enable email login in {{projectName}}: create a login method and add it to the authorization widget. Connect in just a few steps."
keywords: 
  - email login in {{projectName}}
  - Email configuration
...
# How to Connect Email Login in {{projectName}}
