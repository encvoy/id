---
title: "Integrating Rocket.Chat with {{projectName}} — Setting up Single Sign-On"
description: "Learn how to set up Single Sign-On in Rocket.Chat via {{projectName}}: simple configuration, data protection, and convenient access for all company employees."
keywords:
  - integration Rocket.Chat with {{projectName}}
  ...
  - login to Rocket.Chat via {{projectName}}
  - configuring Rocket.Chat with {{projectName}}
  - connecting Rocket.Chat to {{projectName}}
...
# How to Configure Rocket.Chat Integration with {{projectName}}

In this guide, you will learn how to set up Single Sign-On (SSO) in **Rocket.Chat** via the **{{projectName}}** system.
...
4. Specify the connection parameters:
    ...
    - **URL** — The URL of the {{projectName}} service. For example: `https://<{{projectName}} installation address>`
...
After completing all steps, a login button for **{{projectName}}** will appear in the **Rocket.Chat** authorization widget.
