---
title: "Configuring {{projectName}} User Profile — Password and Fields"
description: "Learn how to configure the {{projectName}} user profile: password, basic and additional fields, data validation, email and phone confirmation."
keywords:
keywords:
...
# How to Configure the {{projectName}} User Profile

In this guide, we will explain how to configure the user profile and password policy in **{{projectName}}**. You will learn how to manage profile fields, field validation, and set up email address and phone number confirmation.
...
**Password policy in {{projectName}}** is a set of rules defining requirements for the complexity and security of user passwords. It helps protect accounts from hacking and unauthorized access.
...
2. Expand the **User Profile Settings** block and click on the **Password** panel.
    ...
    <img src="./images/settings-user-profile-01.webp" alt="Configuring user password policy rules in {{projectName}}" style="max-width:600px; width:100%">

3. In the window that appears, click **Configure**.

    <img src="./images/settings-user-profile-02.webp" alt="Validation rules configuration block in {{projectName}}" style="max-width:600px; width:100%">
...
5. Check the boxes for the rules you want to apply to the password.  
    ...
    <img src="./images/settings-user-profile-03.webp" alt="Selecting password validation rules in {{projectName}}" style="max-width:600px; width:100%">  
...
<img src="./images/settings-user-profile-04.webp" alt="Quick view of field settings in {{projectName}}" style="max-width:600px; width:100%">
...
3. Click on the panel of the field you need to configure.
    ...
    <img src="./images/settings-user-profile-05.webp" alt="Configuring basic user profile fields in {{projectName}}>" style="max-width:600px; width:100%">
...
<img src="./images/settings-user-profile-06.webp" alt="Configuring an additional user profile field in {{projectName}}" style="max-width:600px; width:100%">
...
3. Click the **Delete** button ![Delete button](./images/button-delete.webp "Delete button") next to the field you want to delete.  
    ...
    <img src="./images/settings-user-profile-07.webp" alt="Deleting an additional user profile field in {{projectName}}" style="max-width:600px; width:100%">
...
<img src="./images/settings-user-profile-08.webp" alt="Display of defined user profile field validation rules in {{projectName}}" style="max-width:600px; width:100%">
...
3. Click on the panel with the password, basic, or additional field.  
    ...
    <img src="./images/settings-user-profile-01.webp" alt="Password policy configuration block in {{projectName}}" style="max-width:600px; width:100%">

4. The editing form will open.
5. Click **Configure** in the **Validation rules** section.

    <img src="./images/settings-user-profile-02.webp" alt="Validation rules configuration block for profile fields in {{projectName}}" style="max-width:600px; width:100%">
...
7. The rule creation form will open.
    ...
    <img src="./images/settings-user-profile-10.webp" alt="User profile field validation rule creation form in {{projectName}}" style="max-width:600px; width:100%">
...
7. On the rule panel, click the **Delete** button ![Delete button](./images/button-delete.webp "Delete button").  
    ...
    <img src="./images/settings-user-profile-12.webp" alt="Deleting a validation rule for user profile fields in {{projectName}}" style="max-width:600px; width:100%">
...
5. Click **Configure** in the **Validation rules** section.
    ...
    <img src="./images/settings-user-profile-02.webp" alt="Validation rules configuration block in a user profile field in {{projectName}}" style="max-width:600px; width:100%">

6. The validation rules list window will open.

    <img src="./images/settings-user-profile-03.webp" alt="List of validation rules in a user profile field in {{projectName}}" style="max-width:600px; width:100%">
...
**Email confirmation in {{projectName}}** is a mechanism for verifying the validity of the address provided by the user during registration, authorization, or profile data modification.
...
5. In the **Email verification settings** section, click **Add**.
    ...
    <img src="./images/settings-user-profile-14.webp" alt="Adding email confirmation settings for a user profile in {{projectName}}" style="max-width:600px; width:100%">
...
6. In the window that opens, specify the parameters:
    ...
    | **Email image** | Icon that will be displayed in the **{{projectName}}** service interface |
...
5. In the **Email verification settings** section, click the **Configure** button.
    ...
    <img src="./images/settings-user-profile-15.webp" alt="Editing email confirmation settings for a user profile in {{projectName}}" style="max-width:600px; width:100%">
...
5. Click the **Delete** button ![Delete button](./images/button-delete.webp "Delete button") in the **Email verification settings** section.
    ...
    <img src="./images/settings-user-profile-16.webp" alt="Deleting email confirmation settings for a user profile in {{projectName}}" style="max-width:600px; width:100%">

6. Confirm the action in the modal window.

    <img src="./images/settings-user-profile-17.webp" alt="Dialog for deleting email confirmation settings for a user profile in {{projectName}}" style="max-width:400px; width:100%">

---

## Phone Number Confirmation Settings { #phone-confirmation-settings }

**Phone number confirmation in {{projectName}}** is a mechanism for verifying the validity of the contact number provided by the user during registration, login, or profile modification.
...
In the current version of **{{projectName}}**, number confirmation is implemented through integration with the [Call Authorization](https://kloud.one/id/) service of the **Kloud.One** platform. For this mechanism to work, you need to configure the connection to **Kloud.One** by specifying the client ID and secret.
...
5. In the **Phone number verification settings** section, click **Add**.
    ...
    <img src="./images/settings-user-profile-18.webp" alt="Adding phone number confirmation settings for a user profile in {{projectName}}" style="max-width:600px; width:100%">
...
6. In the window that appears, set the necessary parameters:
    ...
    | **Phone image** | - | Icon that will be displayed in the **{{projectName}}** service interface |
...
5. Click the **Delete** button ![Delete button](./images/button-delete.webp "Delete button") in the **Phone number verification settings** section.
    ...
    <img src="./images/settings-user-profile-19.webp" alt="Deleting phone number confirmation settings for a user profile in {{projectName}}" style="max-width:600px; width:100%">

6. Confirm the action in the modal window.

    <img src="./images/settings-user-profile-17.webp" alt="Dialog for deleting phone number confirmation settings for a user profile in {{projectName}}" style="max-width:400px; width:100%">
