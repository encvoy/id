---
title: "Google Login — Connection and Configuration in {{projectName}}"
description: "Learn how to connect Google login in {{projectName}}: create a login method and add it to the authorization widget. Connect in just a few steps."
keywords: 
  - Google login 
  - Google setup in {{projectName}}
...
# How to Connect Google Login in {{projectName}}
...
In this guide, you will learn how to connect authentication using a **Google** account to the **{{projectName}}** system. This login method allows users to sign in to applications using their **Google** service account.
...
Before configuring the login method in **{{projectName}}**, you must register your application in the **Google** developer console and obtain access keys:
...
5. Create an **OAuth Client ID**:
    ...
    - Click **Create**.
      ...
      > ⚠️ After creation, a window will appear with the data: `Client ID` and `Client Secret`. Save these values — you will need them when configuring in **{{projectName}}**.
...
Now, with the keys from **Google**, let's create the corresponding provider in the **{{projectName}}** system.
...
|---|---|---|---|
| **Name** | The name that will be displayed in the **{{projectName}}** service interface | Text | Max 50 characters |
| **Description** | A brief description that will be displayed in the **{{projectName}}** service interface | Text | Max 255 characters |
| **Logo** | The image that will be displayed in the **{{projectName}}** service interface and the login widget | JPG, GIF, PNG, or WEBP | Max size: 1 MB |
...
| **Redirect URI** (non-editable) | `Redirect URI` | The **{{projectName}}** address to which the user is redirected after authentication in the third-party service |
