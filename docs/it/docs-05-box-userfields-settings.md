---
title: "Configurazione del profilo utente {{projectName}} — Password e Campi"
description: "Scopri come configurare il profilo utente {{projectName}}: password, campi base e aggiuntivi, validazione dei dati, conferma email e telefono."
keywords:
keywords:
...
# Come configurare il profilo utente {{projectName}}

In questa guida spiegheremo come configurare il profilo utente e la politica delle password in **{{projectName}}**. Imparerai a gestire i campi del profilo, la validazione dei campi e a impostare la conferma dell'indirizzo email e del numero di telefono.
...
La **politica delle password in {{projectName}}** è un insieme di regole che definiscono i requisiti per la complessità e la sicurezza delle password degli utenti. Aiuta a proteggere gli account da hacking e accessi non autorizzati.
...
2. Espandi il blocco **Configurazione profilo utente** e clicca sul pannello **Password**.
    ...
    <img src="./images/settings-user-profile-01.webp" alt="Configurazione delle regole della politica delle password utente in {{projectName}}" style="max-width:600px; width:100%">

3. Nella finestra che appare, clicca su **Configura**.

    <img src="./images/settings-user-profile-02.webp" alt="Blocco configurazione regole di validazione in {{projectName}}" style="max-width:600px; width:100%">
...
5. Seleziona le caselle per le regole che desideri applicare alla password.  
    ...
    <img src="./images/settings-user-profile-03.webp" alt="Selezione delle regole di validazione della password in {{projectName}}" style="max-width:600px; width:100%">  
...
<img src="./images/settings-user-profile-04.webp" alt="Visualizzazione rapida delle impostazioni dei campi in {{projectName}}" style="max-width:600px; width:100%">
...
3. Clicca sul pannello del campo che devi configurare.
    ...
    <img src="./images/settings-user-profile-05.webp" alt="Configurazione dei campi base del profilo utente in {{projectName}}>" style="max-width:600px; width:100%">
...
<img src="./images/settings-user-profile-06.webp" alt="Configurazione di un campo aggiuntivo del profilo utente in {{projectName}}" style="max-width:600px; width:100%">
...
3. Clicca sul pulsante **Elimina** ![Pulsante Elimina](./images/button-delete.webp "Pulsante Elimina") accanto al campo che desideri eliminare.  
    ...
    <img src="./images/settings-user-profile-07.webp" alt="Eliminazione di un campo aggiuntivo del profilo utente in {{projectName}}" style="max-width:600px; width:100%">
...
<img src="./images/settings-user-profile-08.webp" alt="Visualizzazione delle regole di validazione dei campi del profilo utente definite in {{projectName}}" style="max-width:600px; width:100%">
...
3. Clicca sul pannello con la password, il campo base o aggiuntivo.  
    ...
    <img src="./images/settings-user-profile-01.webp" alt="Blocco configurazione politica password in {{projectName}}" style="max-width:600px; width:100%">

4. Si aprirà il modulo di modifica.
5. Clicca su **Configura** nella sezione **Regole di validazione**.

    <img src="./images/settings-user-profile-02.webp" alt="Blocco configurazione regole di validazione per i campi del profilo in {{projectName}}" style="max-width:600px; width:100%">
...
7. Si aprirà il modulo di creazione della regola.
    ...
    <img src="./images/settings-user-profile-10.webp" alt="Modulo di creazione regola di validazione campo profilo utente in {{projectName}}" style="max-width:600px; width:100%">
...
7. Sul pannello della regola, clicca sul pulsante **Elimina** ![Pulsante Elimina](./images/button-delete.webp "Pulsante Elimina").  
    ...
    <img src="./images/settings-user-profile-12.webp" alt="Eliminazione di una regola di validazione per i campi del profilo utente in {{projectName}}" style="max-width:600px; width:100%">
...
5. Clicca su **Configura** nella sezione **Regole di validazione**.
    ...
    <img src="./images/settings-user-profile-02.webp" alt="Blocco configurazione regole di validazione in un campo del profilo utente in {{projectName}}" style="max-width:600px; width:100%">

6. Si aprirà la finestra dell'elenco delle regole di validazione.

    <img src="./images/settings-user-profile-03.webp" alt="Elenco delle regole di validazione in un campo del profilo utente in {{projectName}}" style="max-width:600px; width:100%">
...
La **conferma email in {{projectName}}** è un meccanismo per verificare la validità dell'indirizzo fornito dall'utente durante la registrazione, l'autorizzazione o la modifica dei dati del profilo.
...
5. Nella sezione **Impostazioni conferma email**, clicca su **Aggiungi**.
    ...
    <img src="./images/settings-user-profile-14.webp" alt="Aggiunta impostazioni di conferma email per un profilo utente in {{projectName}}" style="max-width:600px; width:100%">
...
6. Nella finestra che si apre, specifica i parametri:
    ...
    | **Immagine email** | Icona che verrà visualizzata nell'interfaccia del servizio **{{projectName}}** |
...
5. Nella sezione **Impostazioni conferma email**, clicca sul pulsante **Configura**.
    ...
    <img src="./images/settings-user-profile-15.webp" alt="Modifica impostazioni di conferma email per un profilo utente in {{projectName}}" style="max-width:600px; width:100%">
...
5. Clicca sul pulsante **Elimina** ![Pulsante Elimina](./images/button-delete.webp "Pulsante Elimina") nella sezione **Impostazioni conferma email**.
    ...
    <img src="./images/settings-user-profile-16.webp" alt="Eliminazione impostazioni di conferma email per un profilo utente in {{projectName}}" style="max-width:600px; width:100%">

6. Conferma l'azione nella finestra modale.

    <img src="./images/settings-user-profile-17.webp" alt="Dialogo per l'eliminazione delle impostazioni di conferma email per un profilo utente in {{projectName}}" style="max-width:400px; width:100%">

---

## Impostazioni di Conferma Numero di Telefono { #phone-confirmation-settings }

La **conferma del numero di telefono in {{projectName}}** è un meccanismo per verificare la validità del numero di contatto fornito dall'utente durante la registrazione, il login o la modifica del profilo.
...
5. Nella sezione **Impostazioni conferma numero di telefono**, clicca su **Aggiungi**.
    ...
    <img src="./images/settings-user-profile-18.webp" alt="Aggiunta impostazioni di conferma numero di telefono per un profilo utente in {{projectName}}" style="max-width:600px; width:100%">
...
6. Nella finestra che appare, imposta i parametri necessari:
    ...
    | **Immagine telefono** | - | Icona che verrà visualizzata nell'interfaccia del servizio **{{projectName}}** |
...
5. Clicca sul pulsante **Elimina** ![Pulsante Elimina](./images/button-delete.webp "Pulsante Elimina") nella sezione **Impostazioni conferma numero di telefono**.
    ...
    <img src="./images/settings-user-profile-19.webp" alt="Eliminazione impostazioni di conferma numero di telefono per un profilo utente in {{projectName}}" style="max-width:600px; width:100%">

6. Conferma l'azione nella finestra modale.

    <img src="./images/settings-user-profile-17.webp" alt="Dialogo per l'eliminazione delle impostazioni di conferma numero di telefono per un profilo utente in {{projectName}}" style="max-width:400px; width:100%">
