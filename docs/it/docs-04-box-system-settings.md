---
title: "Configurazione di {{projectName}} — sicurezza, interfaccia e accesso"
description: "Scopri come configurare {{projectName}}: accesso utenti, interfaccia, template email e monitoraggio tramite Sentry. Configura il sistema ora!"
keywords: 
  - configurazione {{projectName}}
  - configurazione accesso {{projectName}}
  - localizzazione 
  - lingua interfaccia 
...
# Come configurare {{projectName}}: sicurezza, interfaccia e accesso

In questa guida imparerai come configurare l'interfaccia e la localizzazione di **{{projectName}}**, creare tipi di applicazioni, gestire l'accesso degli utenti, abilitare l'autenticazione a due fattori e integrare il servizio con Sentry per il monitoraggio degli eventi.

Questa sezione è destinata agli amministratori e agli specialisti della sicurezza che desiderano gestire efficacemente le impostazioni di **{{projectName}}**, inclusi OAuth 2.0 e OpenID Connect.
...
Il nome e il logo vengono visualizzati nell'interfaccia del sistema **{{projectName}}**, così come nel [mini-widget](./docs-09-common-mini-widget-settings.md) e nel [widget di accesso](./docs-06-github-en-providers-settings.md#login-widget-settings).
...
2. Espandi il blocco **Informazioni principali**.
    ...
    <img src="./images/settings-main-info-01.webp" alt="Configurazione nome e logo {{projectName}}" style="max-width:600px; width:100%">
...
4. Nel blocco **Logo dell'applicazione** clicca su **Carica** e seleziona il file del logo.
    ...
    <img src="./images/settings-main-info-02.webp" alt="Interfaccia caricamento logo in {{projectName}}" style="max-width:400px; width:100%">

    > ⚡ Formati supportati: JPG, GIF, PNG, WEBP; dimensione massima 1 MB.

5. Configura la visualizzazione e clicca su **Applica**.

    <img src="./images/settings-main-info-03.webp" alt="Configurazione visualizzazione logo in {{projectName}}" style="max-width:400px; width:100%">
...
**{{projectName}}** supporta l'interfaccia in **sei lingue**:
...
La lingua selezionata influisce sulla visualizzazione del testo in tutte le interfacce di **{{projectName}}**, inclusi il [widget di accesso](./docs-06-github-en-providers-settings.md#login-widget-settings) e il [mini-widget](./docs-09-common-mini-widget-settings.md).
...
2. Espandi il blocco **Localizzazione** e seleziona la lingua desiderata dall'elenco.
    ...
    <img src="./images/settings-localization-01.webp" alt="Configurazione aspetto widget {{projectName}}" style="max-width:600px; width:100%">
...
**Mustache** è un semplice motore di template per l'inserimento di dati in modelli testuali. In **{{projectName}}** viene utilizzato per:
...
3. Seleziona il template desiderato e clicca su **Configura**.
    ...
    <img src="./images/settings-letters-templates-01.webp" alt="Selezione template email per modifica in {{projectName}}" style="max-width:600px; width:100%">
...
4. Nel modulo di modifica che si apre, specifica:
    ...
    <img src="./images/settings-letters-templates-02.webp" alt="Modifica template HTML email in {{projectName}}" style="max-width:600px; width:100%">
...
2. Espandi il blocco **Impostazioni di accesso** e clicca su **Configura**.
    ...
    <img src="./images/settings-access-01.webp" alt="Interfaccia configurazione 2FA in {{projectName}}" style="max-width:600px; width:100%">
...
3. Specifica i provider per il primo e il secondo fattore:
    ...
    <img src="./images/settings-access-02.webp" alt="Configurazione combinazioni fattori 2FA in {{projectName}}" style="max-width:600px; width:100%">
...
| **Indirizzo dell'applicazione** | - | URL di base del servizio **{{projectName}}** nel formato `protocollo://nome-dominio:porta` |
...
Dopo aver creato il progetto, **Sentry** fornirà un **DSN (Data Source Name)** — un identificatore unico per collegare **{{projectName}}** a **Sentry**.
...
3. Nel modulo di collegamento che si apre, specifica:
    ...
    - **ID utente** (se necessario) — specifica se desideri monitorare errori ed eventi per utenti specifici.
      ...
      <img src="./images/settings-sentry-01.webp" alt="Configurazione collegamento Sentry in {{projectName}}" style="max-width:600px; width:100%">
...
4. Si aprirà il modulo di creazione.
    ...
    <img src="./images/settings-app-type-01.webp" alt="Interfaccia creazione tipo applicazione in {{projectName}}" style="max-width:600px; width:100%">
...
3. Si aprirà una finestra con l'elenco dei tipi.
    ...
    <img src="./images/settings-app-type-02.webp" alt="Dialogo creazione tipo applicazione in {{projectName}}" style="max-width:600px; width:100%">
...
Le **funzioni sperimentali** sono nuove funzionalità del servizio **{{projectName}}** in fase di test e perfezionamento.
...
2. **Catalogo applicazioni**
    ...
    - Piattaforma centralizzata per le applicazioni del sistema **{{projectName}}**
    ...
    <img src="./images/personal-profile-22.webp" alt="Interfaccia catalogo in {{projectName}}" style="max-width:400px; width:100%">
