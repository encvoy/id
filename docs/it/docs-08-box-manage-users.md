---
title: "Gestione Utenti in {{projectName}} — Guida per l'Amministratore"
description: "Scopri come gestire gli utenti in {{projectName}}: creazione e modifica, blocco ed eliminazione, controllo degli accessi e gestione della privacy."
keywords: 
  - gestione utenti {{projectName}}
  - creare utente {{projectName}}
  - modificare profilo utente
  - bloccare e sbloccare utente
  - assegnare diritti di accesso {{projectName}}
  - esportare dati profilo
  - terminare sessioni utente
  - identificatori utente
  - eliminare utente {{projectName}}
...
# Gestione Utenti in {{projectName}}

In questa guida imparerai come creare e modificare i profili utente in **{{projectName}}**, assegnare ruoli e diritti di accesso, bloccare ed eliminare account, terminare sessioni attive, gestire la privacy ed esportare i dati del profilo.
...
L'elenco di tutti gli utenti registrati in **{{projectName}}** si trova nella sezione **Utenti**. Qui, gli amministratori possono gestire gli account, visualizzare i profili e controllare l'accesso al sistema.
...
### Creazione di un Utente in {{projectName}}

> 📌 In **{{projectName}}**, esistono diversi modi per registrare gli utenti: l'autoregistrazione tramite widget e la creazione manuale da parte di un utente con diritti di **Amministratore**.  
...
3. Si aprirà il profilo utente con informazioni dettagliate: dati di contatto, identificatori e impostazioni sulla privacy.
    ...
    <img src="./images/manage-user-01.webp" alt="Visualizzazione di un profilo utente in {{projectName}}" style="max-width:700px; width:100%">
...
La sezione **Identificatori** del profilo utente mostra i metodi di accesso che l'utente ha aggiunto personalmente o utilizzato per accedere all'applicazione o all'account personale di **{{projectName}}**. L'amministratore può configurare la privacy di un identificatore e rimuoverlo dal profilo utente.
...
3. Clicca su **Elimina** nel pannello del metodo di accesso che desideri rimuovere dal profilo.
    ...
    <img src="./images/manage-user-02.webp" alt="Eliminazione di un identificatore da un profilo utente {{projectName}}" style="max-width:600px; width:100%">
...
| **Disponibile su richiesta** | ![Access by approval](./images/button-approve.webp) | I dati sono disponibili in sistemi di terze parti integrati con **{{projectName}}**. <br> È richiesto il consenso dell'utente per accedere ai dati. |
...
4. Seleziona un nuovo livello dal menu a discesa.
    ...
    <img src="./images/manage-user-03.webp" alt="Menu azioni per la gestione di utenti e ruoli in {{projectName}}" style="max-width:600px; width:100%">  

La modifica viene applicata istantaneamente.

### Esportazione dei Dati del Profilo

**{{projectName}}** consente di esportare tutti i dati del profilo in formato JSON.
...
3. Espandi il blocco **Altre azioni**.
    ...
    <img src="./images/manage-user-04.webp" alt="Download dei dati del profilo utente in {{projectName}}" style="max-width:600px; width:100%">
...
2. Clicca su **Termina sessioni** nel menu azioni dell'utente.  
    ...
    <img src="./images/manage-user-05.webp" alt="Terminazione delle sessioni utente nell'elenco utenti di {{projectName}}" style="max-width:600px; width:100%">
...
2. Clicca su **Termina sessioni** nel profilo utente all'interno del blocco **Altre azioni**.
    ...
    <img src="./images/manage-user-06.webp" alt="Terminazione delle sessioni utente nel profilo utente di {{projectName}}" style="max-width:600px; width:100%">
...
{{projectName}} utilizza un sistema di accesso a tre livelli che definisce chiaramente i diritti degli utenti:
...
3. Seleziona l'azione **Cambia permessi**.
    ...
    <img src="./images/manage-user-18.webp" alt="Assegnazione di un ruolo utente nell'elenco utenti di {{projectName}}" style="max-width:600px; width:100%">

4. Nella finestra che si apre, seleziona il ruolo **Gestore** e clicca su **Salva**.

    <img src="./images/manage-user-07.webp" alt="Finestra di dialogo per la selezione dei permessi utente {{projectName}}" style="max-width:400px; width:100%">
...
### Blocco degli Utenti in {{projectName}}

Il blocco impedisce l'accesso a tutti i servizi che utilizzano **{{projectName}}** per l'accesso.
...
1. Apri il menu azioni per un utente attivo in una delle interfacce:
    ...
    <img src="./images/manage-user-12.webp" alt="Blocco di un utente nell'elenco utenti di {{projectName}}" style="max-width:600px; width:100%">

2. Seleziona l'azione **Blocca in {{projectName}}**.
3. Conferma l'azione nella finestra modale.

    <img src="./images/manage-user-09.webp" alt="Finestra di dialogo di conferma per il blocco di un utente in {{projectName}}" style="max-width:400px; width:100%">  

**Cosa succede dopo il blocco**:

- Lo stato dell'utente cambierà in **Bloccato**.

    <img src="./images/manage-user-10.webp" alt="Stato utente bloccato nell'elenco utenti di {{projectName}}" style="max-width:600px; width:100%">
...
- L'utente bloccato non potrà accedere al servizio o alle applicazioni.
    ...
    <img src="./images/manage-user-11.webp" alt="Esempio di widget di accesso per un utente {{projectName}} bloccato" style="max-width:300px; width:100%">

### Sblocco degli Utenti in {{projectName}}
...
Un amministratore può eliminare definitivamente un utente. Una volta confermata l'eliminazione, l'account e tutti i dati scompariranno irrevocabilmente. L'utente perderà l'accesso a tutte le applicazioni in cui è stato utilizzato il suo account **{{projectName}}**.
...
### Come Eliminare un Utente in {{projectName}}
...
1. Clicca su **Elimina account** in una delle interfacce:
     ...
     - Nel menu azioni dell'utente nella scheda **Utenti**.  
        ...
        <img src="./images/manage-user-16.webp" alt="Menu azioni utente in {{projectName}}" style="max-width:600px; width:100%">

     - Nel profilo utente all'interno del blocco **Altre azioni**.  

        <img src="./images/manage-user-15.webp" alt="Menu azioni profilo utente in {{projectName}}" style="max-width:600px; width:100%">
...
- [Gestione delle Organizzazioni](./docs-02-box-system-install.md) — una guida al lavoro con le organizzazioni in **{{projectName}}**.