---
title: "Configuration du profil utilisateur {{projectName}} — Mot de passe et champs"
description: "Découvrez comment configurer le profil utilisateur {{projectName}} : mot de passe, champs de base et supplémentaires, validation des données, confirmation par e-mail et téléphone."
keywords:
keywords:
  - {{projectName}} user profile configuration
  - {{projectName}} user profile
  - {{projectName}} user settings
  - {{projectName}} profile management
  - {{projectName}} password policy
  - password policy configuration
  - password requirements
  - user profile field validation
  - {{projectName}} validation rules
...
# Comment configurer le profil utilisateur {{projectName}}

Dans ce guide, nous expliquerons comment configurer le profil utilisateur et la politique de mot de passe dans **{{projectName}}**. Vous apprendrez à gérer les champs de profil, la validation des champs et à configurer la confirmation de l'adresse e-mail et du numéro de téléphone.
...
La **politique de mot de passe dans {{projectName}}** est un ensemble de règles définissant les exigences de complexité et de sécurité des mots de passe des utilisateurs. Elle aide à protéger les comptes contre le piratage et les accès non autorisés.
...
2. Développez le bloc **Configuration du profil utilisateur** et cliquez sur le panneau **Mot de passe**.
    ...
    <img src="./images/settings-user-profile-01.webp" alt="Configuration des règles de politique de mot de passe utilisateur dans {{projectName}}" style="max-width:600px; width:100%">

3. Dans la fenêtre qui apparaît, cliquez sur **Configurer**.

    <img src="./images/settings-user-profile-02.webp" alt="Bloc de configuration des règles de validation dans {{projectName}}" style="max-width:600px; width:100%">
...
5. Cochez les cases des règles que vous souhaitez appliquer au mot de passe.  
    ...
    <img src="./images/settings-user-profile-03.webp" alt="Sélection des règles de validation de mot de passe dans {{projectName}}" style="max-width:600px; width:100%">  
...
<img src="./images/settings-user-profile-04.webp" alt="Vue rapide des paramètres de champ dans {{projectName}}" style="max-width:600px; width:100%">
...
3. Cliquez sur le panneau du champ que vous devez configurer.
    ...
    <img src="./images/settings-user-profile-05.webp" alt="Configuration des champs de profil utilisateur de base dans {{projectName}}>" style="max-width:600px; width:100%">
...
<img src="./images/settings-user-profile-06.webp" alt="Configuration d'un champ de profil utilisateur supplémentaire dans {{projectName}}" style="max-width:600px; width:100%">
...
3. Cliquez sur le bouton **Supprimer** ![Bouton supprimer](./images/button-delete.webp "Bouton supprimer") à côté du champ que vous souhaitez supprimer.  
    ...
    <img src="./images/settings-user-profile-07.webp" alt="Suppression d'un champ de profil utilisateur supplémentaire dans {{projectName}}" style="max-width:600px; width:100%">
...
<img src="./images/settings-user-profile-08.webp" alt="Affichage des règles de validation des champs de profil utilisateur définies dans {{projectName}}" style="max-width:600px; width:100%">
...
3. Cliquez sur le panneau avec le mot de passe, le champ de base ou supplémentaire.  
    ...
    <img src="./images/settings-user-profile-01.webp" alt="Bloc de configuration de la politique de mot de passe dans {{projectName}}" style="max-width:600px; width:100%">

4. Le formulaire d'édition s'ouvrira.
5. Cliquez sur **Configurer** dans la section **Règles de validation**.

    <img src="./images/settings-user-profile-02.webp" alt="Bloc de configuration des règles de validation pour les champs de profil dans {{projectName}}" style="max-width:600px; width:100%">
...
7. Le formulaire de création de règle s'ouvrira.
    ...
    <img src="./images/settings-user-profile-10.webp" alt="Formulaire de création de règle de validation de champ de profil utilisateur dans {{projectName}}" style="max-width:600px; width:100%">
...
7. Sur le panneau de la règle, cliquez sur le bouton **Supprimer** ![Bouton supprimer](./images/button-delete.webp "Bouton supprimer").  
    ...
    <img src="./images/settings-user-profile-12.webp" alt="Suppression d'une règle de validation pour les champs de profil utilisateur dans {{projectName}}" style="max-width:600px; width:100%">
...
5. Cliquez sur **Configurer** dans la section **Règles de validation**.
    ...
    <img src="./images/settings-user-profile-02.webp" alt="Bloc de configuration des règles de validation dans un champ de profil utilisateur dans {{projectName}}" style="max-width:600px; width:100%">

6. La fenêtre de la liste des règles de validation s'ouvrira.

    <img src="./images/settings-user-profile-03.webp" alt="Liste des règles de validation dans un champ de profil utilisateur dans {{projectName}}" style="max-width:600px; width:100%">
...
La **confirmation d'e-mail dans {{projectName}}** est un mécanisme permettant de vérifier la validité de l'adresse fournie par l'utilisateur lors de l'inscription, de l'autorisation ou de la modification des données du profil.
...
5. Dans la section **Paramètres de confirmation de l'e-mail**, cliquez sur **Ajouter**.
    ...
    <img src="./images/settings-user-profile-14.webp" alt="Ajout de paramètres de confirmation d'e-mail pour un profil utilisateur dans {{projectName}}" style="max-width:600px; width:100%">
...
6. Dans la fenêtre qui s'ouvre, spécifiez les paramètres :
    ...
    | **Image de l'e-mail** | Icône qui sera affichée dans l'interface du service **{{projectName}}** |
...
5. Dans la section **Paramètres de confirmation de l'e-mail**, cliquez sur le bouton **Configurer**.
    ...
    <img src="./images/settings-user-profile-15.webp" alt="Modification des paramètres de confirmation d'e-mail pour un profil utilisateur dans {{projectName}}" style="max-width:600px; width:100%">
...
5. Cliquez sur le bouton **Supprimer** ![Bouton supprimer](./images/button-delete.webp "Bouton supprimer") dans la section **Paramètres de confirmation de l'e-mail**.
    ...
    <img src="./images/settings-user-profile-16.webp" alt="Suppression des paramètres de confirmation d'e-mail pour un profil utilisateur dans {{projectName}}" style="max-width:600px; width:100%">

6. Confirmez l'action dans la fenêtre modale.

    <img src="./images/settings-user-profile-17.webp" alt="Dialogue de suppression des paramètres de confirmation d'e-mail pour un profil utilisateur dans {{projectName}}" style="max-width:400px; width:100%">

---

## Paramètres de confirmation de numéro de téléphone { #phone-confirmation-settings }

La **confirmation du numéro de téléphone dans {{projectName}}** est un mécanisme permettant de vérifier la validité du numéro de contact fourni par l'utilisateur lors de l'inscription, de la connexion ou de la modification du profil.
...
Dans la version actuelle de **{{projectName}}**, la confirmation du numéro est implémentée via l'intégration avec le service [Call Authorization](https://kloud.one/id/) de la plateforme **Kloud.One**. Pour que ce mécanisme fonctionne, vous devez configurer la connexion à **Kloud.One** en spécifiant l'ID client et le secret.
...
5. Dans la section **Paramètres de confirmation du numéro de téléphone**, cliquez sur **Ajouter**.
    ...
    <img src="./images/settings-user-profile-18.webp" alt="Ajout de paramètres de confirmation de numéro de téléphone pour un profil utilisateur dans {{projectName}}" style="max-width:600px; width:100%">
...
6. Dans la fenêtre qui apparaît, définissez les paramètres nécessaires :
    ...
    | **Image du téléphone** | - | Icône qui sera affichée dans l'interface du service **{{projectName}}** |
...
5. Cliquez sur le bouton **Supprimer** ![Bouton supprimer](./images/button-delete.webp "Bouton supprimer") dans la section **Paramètres de confirmation du numéro de téléphone**.
    ...
    <img src="./images/settings-user-profile-19.webp" alt="Suppression des paramètres de confirmation de numéro de téléphone pour un profil utilisateur dans {{projectName}}" style="max-width:600px; width:100%">

6. Confirmez l'action dans la fenêtre modale.

    <img src="./images/settings-user-profile-17.webp" alt="Dialogue de suppression des paramètres de confirmation de numéro de téléphone pour un profil utilisateur dans {{projectName}}" style="max-width:400px; width:100%">
